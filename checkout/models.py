...
class Order(models.Model):
    ...
    def update_total(self):
        """ To update grand total when a line item is added"""
    ...
    def save(self, *args, **kwargs):
        """To override the save method and set the order number
...
class OrderLineItem(models.Model):
    ...
    gin = models.ForeignKey(Gin, null=False, blank=False,
                            on_delete=models.CASCADE)
    ...
    def save(self, *args, **kwargs):
        """To override the save method and set the lineitem
